...
export const siteConfig: SiteConfig = {
	...
	author: "Djroton Noé SOSSOU",
	// Meta property used to construct the meta title property, found in src/components/BaseHead.astro L:11
	title: "Portfolio de Djroton",
	// Meta property used as a default description meta property
	description: "Djroton Noé SOSSOU, développeur front-end passionné, une solide expertise dans les technologies modernes du web et les meilleures pratiques de développement.",
